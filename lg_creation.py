    ...
    # Process the complete information and reset
        ...
        if 'parent_path' in syscall_info and 'file_path' in syscall_info:
            ...
            with open(output_file, 'a') as outfile:
                    ...
                    outfile.write(f"Conclusion: {syscall_info['conclusion']}, Timestamp: {human_readable_timestamp}, Command: {syscall_info['cmd']}, Syscall:{syscall_info['Syscall']}, AUID: {syscall_info['auid']}, UID: {syscall_info['uid']}, Path: {full_path}\n")
